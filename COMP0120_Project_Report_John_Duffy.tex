...
\begin{figure}[H]
	...
	\begin{subfigure}{1.0\textwidth}
		...
		\caption{$P_1 = [3.0, 3.0]^T \in \{-1\}, P_2 = [6.0, 6.0]^T \in \{+1\}$}
	\end{subfigure}
	\begin{subfigure}{1.0\textwidth}
		\centering
	...
	\end{subfigure}
	\caption{Two data points are used to determine the \emph{convex} minimisation problem $\mathcal{L}_D(\alpha)$.}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}{1.0\textwidth}
		...
		\caption{$[3.0, 6.0]^T \in \{-1\}, [6.0, 3.0]^T \in \{+1\}$}
	\end{subfigure}
	\begin{subfigure}{1.0\textwidth}
		\centering
