...
The aim of this simulation study is to gain a deeper understanding of the underlying mathematics, and also an intuitive understanding, of Linear Binary Classification SMVs.
...
For this $\mathcal{R}^2$ case, the equality constraint can be re-stated as:
...
Now, consider the data points $[3.0, 3.0]^T \in \{Class -1\}$, and $[6.0, 6.0]^T \in \{Class +1\}$. These data points and the resultant $\mathcal{L}_D(\alpha)$, having used these data points $\mathbf{w}$ and their classifications $y$ in determining $\mathbf{H}$, are depicted in Figure 4 together with the constraints.
