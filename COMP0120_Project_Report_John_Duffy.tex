...
%A number of MatLab functions that were used in previous COMP0120 assignments have been reimplemented in MatLab, specifically \emph{backtracking()}, \emph{steepest_descent()} and \emph{newton()} functions.

%To test the functionality of these functions they were tested using the \emph{Rosenbrock} function and the results compared to the \emph{MatLab} results from Assignment 1.
%\begin{figure}[H]
%	\centering	
%	\begin{subfigure}{1.0\textwidth}
%		\centering
